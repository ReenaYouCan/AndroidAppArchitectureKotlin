...
class GameFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        Log.i("GameFragment", "Called GameView Model")
        ...
        gameViewModel.word.observe(this, Observer { nextWord ->
            binding.wordText.text = nextWord

        })

        gameViewModel.eventGameFinish.observe(this, Observer { eventFinished ->
            if (eventFinished)
                gameFinished()
        })

        gameViewModel.currentTime.observe(this, Observer { currentTime ->
